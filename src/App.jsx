...
/* =========================================================================
   STORAGE SHIM
   ---------------------------------------------------------------------
   This app was originally built inside Claude's artifact sandbox, which
   provides a built-in `window.storage` key-value API. Real browsers
   don't have that, so this shim backs it with localStorage instead —
   everything below this block works unchanged.

   IMPORTANT: localStorage is per-browser / per-device only. That's fine
   for trying the site out, but it means an admin change made on your
   laptop won't show up for a customer on their phone, and orders placed
   by customers won't appear in your admin dashboard unless they're on
   the same browser. For a real multi-device store, swap this shim for
   a real backend (Firebase, Supabase, or your own API) — see the
   README that ships with this project for pointers.
   ========================================================================= */
...
const SAMPLE_WATCHES = [
  { id: "w1", name: "Meridian Chrono", type: "watch", category: "Women's", style: "Luxury", price: 2500, originalPrice: 2000, description: "A steel chronograph with a sunburst dial, built for the boardroom and beyond.", images: ["https://cdn.phototourl.com/free/2026-09-10-f5f7b024-c965-42a2-a1ba-52ce79f5fe62.jpg", "https://picsum.photos/seed/radiant-w1b/900/1100", "https://picsum.photos/seed/radiant-w1c/900/1100"], colors: ["Silver", "Gunmetal"], sizes: ["40mm", "42mm"], rating: 4.8, reviews: 126, featured: true, bestseller: true, newArrival: false, stock: 14 },
  { id: "w2", name: "Aria Minimal", type: "watch", category: "Women's", style: "Casual", price: 1490, originalPrice: 14900, description: "A slim, understated dress watch with a mother-of-pearl face.", images: ["https://cdn.phototourl.com/free/2026-09-10-93c7fcb8-5eb4-460a-b481-165a68615af6.jpg", "https://picsum.photos/seed/radiant-w2b/900/1100"], colors: ["Rose Gold", "Silver"], sizes: ["32mm"], rating: 4.6, reviews: 84, featured: true, bestseller: false, newArrival: true, stock: 20 },
  { id: "w3", name: "Voyager Field", type: "watch", category: "Women's", style: "Sports", price: 1890, originalPrice: 21500, description: "Shock-resistant field watch built for travel, hiking and everyday wear.", images: ["https://cdn.phototourl.com/free/2026-09-10-ea7ee005-2d0c-421a-ab43-1aca70e48a3d.jpg", "https://picsum.photos/seed/radiant-w3b/900/1100"], colors: ["Olive", "Black"], sizes: ["44mm"], rating: 4.7, reviews: 61, featured: false, bestseller: true, newArrival: false, stock: 9 },
  { id: "w4", name: "Solstice Gold", type: "watch", category: "Women's", style: "Luxury", price: 3850, originalPrice: 38500, description: "A statement piece in warm gold-tone stainless steel with a link bracelet.", images: ["https://cdn.phototourl.com/free/2026-09-10-f5f7b024-c965-42a2-a1ba-52ce79f5fe62.jpg", "https://picsum.photos/seed/radiant-w4b/900/1100"], colors: ["Gold"], sizes: ["38mm", "41mm"], rating: 4.9, reviews: 203, featured: true, bestseller: true, newArrival: false, stock: 6 },
  { id: "w5", name: "Nocturne Black", type: "watch", category: "Women's", style: "Casual", price: 1650, originalPrice: 19900, description: "Matte black IP-coated case with a smoked sapphire-style crystal.", images: ["https://cdn.phototourl.com/free/2026-09-10-4e5b6969-0d22-4eb9-a3cd-5cc2266ddf3c.jpg", "https://picsum.photos/seed/radiant-w5b/900/1100"], colors: ["Black"], sizes: ["42mm"], rating: 4.5, reviews: 47, featured: false, bestseller: false, newArrival: true, stock: 17 },
  { id: "w6", name: "Petal Rose", type: "watch", category: "Women's", style: "Casual", price: 1290, originalPrice: 12900, description: "A soft rose-gold case paired with a genuine leather strap.", images: ["https://cdn.phototourl.com/free/2026-09-10-d9288363-e94b-4e84-9a2f-d28b3124a70b.webp", "https://picsum.photos/seed/radiant-w6b/900/1100"], colors: ["Rose Gold", "Tan"], sizes: ["34mm"], rating: 4.4, reviews: 38, featured: false, bestseller: false, newArrival: true, stock: 22 },
  { id: "w7", name: "Regatta Diver", type: "watch", category: "Wpmen's", style: "Sports", price: 2900, originalPrice: 31900, description: "200m water resistant diver with a unidirectional rotating bezel.", images: ["https://cdn.phototourl.com/member/2026-09-10-05eb8e7d-b75b-4b40-aea3-a3f62d25ab05.jpg", "https://picsum.photos/seed/radiant-w7b/900/1100"], colors: ["Blue", "Black"], sizes: ["43mm"], rating: 4.8, reviews: 152, featured: true, bestseller: false, newArrival: false, stock: 11 },
  { id: "w8", name: "Halcyon Unisex", type: "watch", category: "Women's", style: "Luxury", price: 2100, originalPrice: 21900, description: "A balanced 39mm case designed to sit comfortably on any wrist.", images: ["https://cdn.phototourl.com/free/2026-09-10-f5f7b024-c965-42a2-a1ba-52ce79f5fe62.jpg", "https://picsum.photos/seed/radiant-w8b/900/1100"], colors: ["Silver", "Gold"], sizes: ["39mm"], rating: 4.6, reviews: 29, featured: false, bestseller: true, newArrival: false, stock: 15 },
];

const SAMPLE_BRACELETS = [
  { id: "b1", name: "Cuban Link Steel", type: "bracelet", category: "Men's", style: "Chain", price: 6900, originalPrice: 8900, description: "A heavyweight Cuban link chain in brushed stainless steel.", images: ["https://cdn.phototourl.com/member/2026-09-10-0c6d0ce9-2b20-4b24-816c-f0e8d60858cb.jpg", "https://picsum.photos/seed/radiant-b1b/900/1100"], colors: ["Silver", "Gold"], sizes: ["7.5in", "8.5in"], rating: 4.7, reviews: 96, featured: true, bestseller: true, newArrival: false, stock: 25 },
  { id: "b2", name: "Woven Leather Wrap", type: "bracelet", category: "Men's", style: "Leather", price: 3200, originalPrice: 3200, description: "Hand-woven leather wrap bracelet with a magnetic clasp.", images: ["https://cdn.phototourl.com/member/2026-09-10-9fc7a647-c1fe-452e-aed9-0a8601e7dece.jpg", "https://picsum.photos/seed/radiant-b2b/900/1100"], colors: ["Brown", "Black"], sizes: ["One Size"], rating: 4.5, reviews: 41, featured: false, bestseller: false, newArrival: true, stock: 30 },
  { id: "b3", name: "Pearl Beaded Strand", type: "bracelet", category: "Women's", style: "Beaded", price: 2800, originalPrice: 3600, description: "Freshwater pearls hand-strung on elastic cord.", images: ["https://cdn.phototourl.com/member/2026-09-10-093362f8-1b6f-4770-93b2-b0aab806cbf5.jpg", "https://picsum.photos/seed/radiant-b3b/900/1100"], colors: ["White", "Ivory"], sizes: ["One Size"], rating: 4.6, reviews: 58, featured: true, bestseller: false, newArrival: false, stock: 40 },
  { id: "b4", name: "Friendship Duo Set", type: "bracelet", category: "Couple", style: "Friendship", price: 1900, originalPrice: 1900, description: "A matching pair of adjustable cord bracelets for two.", images: ["https://cdn.phototourl.com/member/2026-09-10-6d099e5c-74cc-4520-a6ad-fc7fbc117200.jpg", "https://picsum.photos/seed/radiant-b4b/900/1100"], colors: ["Black/Gold", "Red/Silver"], sizes: ["One Size"], rating: 4.8, reviews: 112, featured: true, bestseller: true, newArrival: true, stock: 50 },
  { id: "b5", name: "Gold Bangle Trio", type: "bracelet", category: "Women's", style: "Chain", price: 5400, originalPrice: 6200, description: "Three stacking bangles in a warm gold finish.", images: ["https://cdn.phototourl.com/member/2026-09-10-093362f8-1b6f-4770-93b2-b0aab806cbf5.jpg", "https://picsum.photos/seed/radiant-b5b/900/1100"], colors: ["Gold"], sizes: ["S", "M", "L"], rating: 4.4, reviews: 33, featured: false, bestseller: false, newArrival: false, stock: 18 },
  { id: "b6", name: "Onyx Bead Stack", type: "bracelet", category: "Unisex", style: "Beaded", price: 2400, originalPrice: 2400, description: "Matte onyx beads with a brushed steel accent bead.", images: ["https://cdn.phototourl.com/member/2026-09-10-0c6d0ce9-2b20-4b24-816c-f0e8d60858cb.jpg", "https://picsum.photos/seed/radiant-b6b/900/1100"], colors: ["Black"], sizes: ["S", "M", "L"], rating: 4.7, reviews: 71, featured: false, bestseller: true, newArrival: false, stock: 27 },
  { id: "b7", name: "Braided Cord Classic", type: "bracelet", category: "Men's", style: "Friendship", price: 1500, originalPrice: 1900, description: "A simple braided cord bracelet with an anchor clasp.", images: ["https://picsum.photos/seed/radiant-b7a/900/1100", "https://picsum.photos/seed/radiant-b7b/900/1100"], colors: ["Navy", "Khaki"], sizes: ["One Size"], rating: 4.3, reviews: 22, featured: false, bestseller: false, newArrival: true, stock: 35 },
  { id: "b8", name: "Slim Leather Band", type: "bracelet", category: "Unisex", style: "Leather", price: 2100, originalPrice: 2100, description: "A slim, minimal leather band that layers well with watches.", images: ["https://cdn.phototourl.com/member/2026-09-10-9fc7a647-c1fe-452e-aed9-0a8601e7dece.jpg", "https://picsum.photos/seed/radiant-b8b/900/1100"], colors: ["Black", "Brown", "Tan"], sizes: ["One Size"], rating: 4.5, reviews: 19, featured: true, bestseller: false, newArrival: true, stock: 44 },
];

const REVIEWS = [
  { name: "Ayesha K.", text: "Packaging felt genuinely premium.", rating: 5 },
...
/* Storage keys */
const K_CART = "radiant:cart";
const K_CATALOG = "radiant:catalog";
const K_ORDERS = "radiant:orders";
const K_SETTINGS = "radiant:settings";
const ORDER_TABLE = "orders";
const ORDER_EMAIL_FUNCTION = "send-order-notification";
...
const normaliseOrder = (row) => {
  ...
  const customer = row.customer || {
    ...
    address: row.address || "",
    city: row.city || "",
    postal: row.postal || row.postal_code || "",
    payment: row.payment || row.payment_method || "",
  };
  const lines = row.lines || row.items || row.order_items || [];
  return {
    ...row,
    id: row.order_id || row.order_number || row.id,
    ...
    payment: row.payment || row.payment_method || customer.payment || "",
...
const adminLogout = async () => {
  ...
  (async () => {
    try {
      // Restore an existing Supabase admin session after a page refresh.
      const { data: sessionData } = await supabase.auth.getSession();
      setAdminLoggedIn(Boolean(sessionData?.session));

      // Load cart from localStorage
      const c = await window.storage.get(K_CART, false);
      if (c && c.value) {
        setCart(JSON.parse(c.value));
      }
      ...
      if (error) {
        ...
        setProducts([...SAMPLE_WATCHES, ...SAMPLE_BRACELETS]);
      }

       // Keep local orders as a cache, then replace them with the Supabase
       // orders visible to the current admin session.
      try {
        const o = await window.storage.get(K_ORDERS, true);
        if (o && o.value) {
           setOrders(JSON.parse(o.value).map(normaliseOrder));
        }
      } catch (e) {}
       ...
       if (sessionData?.session) {
         ...
         } else if (Array.isArray(orderRows)) {
           setOrders(orderRows.map(normaliseOrder).filter(Boolean));
         }
       }
  ...
  const placeOrder = async (customer, linesToOrder = cartLines, totals = { subtotal, deliveryFee, total }, clearCart = true) => {
    setOrderError("");
    const order = {
      id: createOrderId(),
      date: new Date().toISOString(),
      customer,
      lines: linesToOrder.map((l) => ({ productId: l.product.id, name: l.product.name, color: l.color, size: l.size, qty: l.qty, price: l.product.price })),
    ...
    /*
     * The orders table must expose the fields below (or equivalent aliases)
     * and the insert must be allowed by its INSERT RLS policy. The frontend
     * never uses a service-role key. If your existing table uses different
     * names, change this one adapter rather than changing the checkout flow.
     */
    // Map the checkout order to the columns that actually exist
    // in the public.orders table.
    //
    // Supabase "id" is a UUID generated by gen_random_uuid().
    // Our human-readable RAD-... value belongs in "order_id".
    const orderRow = {
      order_id: order.id,
    ...
    // Do not use .select() here. The customer is anonymous, and
    // the INSERT should not require a public SELECT policy.
    const { error: saveError } = await supabase
      .from(ORDER_TABLE)
      .insert(orderRow);

    if (saveError) {
      console.error("SUPABASE ORDER ERROR:", saveError);
      ...
      setOrderError("We couldn't save your order. Please check your details and try again.");
      return null;
    }

    // The database insert succeeded. Keep the same human-readable
    // order object for the confirmation page and local admin state.
   const savedOrder = order;

setOrders((prev) => [
  savedOrder,
  ...prev.filter((existing) => existing.id !== savedOrder.id)
]);

if (clearCart) setCart([]);

console.log("ORDER EMAIL: starting");

const { data: emailData, error: emailError } =
  await supabase.functions.invoke("send-order-notification", {
    body: {
      order: savedOrder,
      recipient: "sabeenarain.0@gmail.com",
    },
  });
...
return savedOrder;
    if (emailError) {
      // An email failure must not turn a successful order into a failed order.
    ...
    <div className="min-h-screen w-full" style={{ fontFamily: "'Inter', sans-serif", background: "#0D0D0D", color: "#F5F1E8" }}>
      ...
      <main>
        ...
        {page.name === "shop" && <ShopPage settings={settings} products={products} type={page.type} go={go} addToCart={addToCart} initialCategory={page.category} />}
         {page.name === "product" && <ProductDetails settings={settings} products={products} id={page.id} go={go} addToCart={addToCart} buyNow={(product, opts) => go("checkout", { directLine: { productId: product.id, color: opts.color, size: opts.size, qty: opts.qty } })} />}
        ...
        {page.name === "cart" && <CartPage settings={settings} lines={cartLines} updateQty={updateQty} removeLine={removeLine} subtotal={subtotal} deliveryFee={deliveryFee} total={total} go={go} />}
         {page.name === "checkout" && (() => {
           const directProduct = page.directLine && products.find((product) => product.id === page.directLine.productId);
           const checkoutLines = directProduct
             ? [{ ...page.directLine, product: directProduct }]
             : cartLines;
           const checkoutSubtotal = checkoutLines.reduce((sum, line) => sum + line.product.price * line.qty, 0);
           const checkoutDeliveryFee = checkoutSubtotal === 0 || checkoutSubtotal >= settings.freeDeliveryOver ? 0 : settings.deliveryCharge;
           return <CheckoutPage
             settings={settings}
             lines={checkoutLines}
             subtotal={checkoutSubtotal}
             deliveryFee={checkoutDeliveryFee}
             total={checkoutSubtotal + checkoutDeliveryFee}
             go={go}
             placeOrder={placeOrder}
             orderError={orderError}
             clearCart={!directProduct}
           />;
         })()}
        {page.name === "confirmation" && <ConfirmationPage settings={settings} order={page.order} go={go} />}
        {page.name === "admin" && (adminLoggedIn ? (
      <AdminPage
      settings={settings}
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-8 pt-10 md:pt-16 pb-12 grid md:grid-cols-2 gap-8 md:gap-4 items-center">
        ...
        <div className="order-1 md:order-2">
          <div className="aspect-[4/5] md:aspect-[3/4] overflow-hidden">
            <img src="https://picsum.photos/seed/radiant-hero/1000/1300" alt="Featured watch on a wrist" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
...
/* =========================================================================
   ...
   ========================================================================= */
 function ProductDetails({ settings, products, id, go, addToCart, buyNow }) {
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-8">
            <button onClick={() => addToCart(product, { color, size, qty })} className="flex-1 border border-[#C6A15B] py-3.5 text-sm tracking-wide hover:bg-[#C6A15B] hover:text-[#0D0D0D] transition-colors">Add to Cart</button>
             <button onClick={() => buyNow(product, { color, size, qty })} className="flex-1 bg-[#C6A15B] text-[#0D0D0D] py-3.5 text-sm tracking-wide hover:bg-[#D8B978] transition-colors">Buy Now</button>
          </div>
...
/* =========================================================================
   CHECKOUT PAGE
   ========================================================================= */
 function CheckoutPage({ settings, lines, subtotal, deliveryFee, total, go, placeOrder, orderError, clearCart }) {
  ...
  if (lines.length === 0) {
   ...
   const submit = async (e) => {
    e.preventDefault();
     setSubmitting(true);
     const order = await placeOrder(form, lines, { subtotal, deliveryFee, total }, clearCart);
     setSubmitting(false);
     if (order) go("confirmation", { order });
  };
      ...
      <form onSubmit={submit} className="grid md:grid-cols-[1fr_320px] gap-10">
        ...
        <div className="border hairline p-5 h-fit">
          ...
          <div className="space-y-2 text-sm border-t hairline pt-3">
           ...
           {orderError && <p className="text-sm text-red-400 mt-4" role="alert">{orderError}</p>}
           <button type="submit" disabled={submitting} className="w-full bg-[#C6A15B] text-[#0D0D0D] py-3.5 mt-5 text-sm tracking-wide hover:bg-[#D8B978] disabled:opacity-60 transition-colors">{submitting ? "Saving Order…" : "Place Order"}</button>
        </div>
      </form>
    </div>
  );
  ...
  return (
    <div className="max-w-xl mx-auto px-5 py-20 text-center">
      ...
      <h1 className="font-display text-3xl mb-2">Order confirmed</h1>
       <p className="text-[#A9A49A] mb-6">Order #{order.id} · Paying via {order.payment}. Your order has been saved successfully.</p>
...
function AdminLogin({ adminLogin, go }) {
  ...
  const submit = async (event) => {
    ...
    const success = await adminLogin(form.email.trim(), form.password);
  ...
  return (
    <div className="max-w-md mx-auto px-5 md:px-8 py-20">
      <div className="border hairline p-6 md:p-8">
        <p className="text-[13px] text-[#C6A15B] mb-2">Store Administration</p>
        <h1 className="font-display text-3xl mb-2">Admin Login</h1>
        <p className="text-sm text-[#A9A49A] mb-6">
          Sign in with the admin account configured in Supabase.
        </p>

        <form onSubmit={submit} className="space-y-4">
          <label className="block text-sm">
            <span className="block text-[12px] text-[#A9A49A] mb-1">Email</span>
            <input
              required
              type="email"
              ...
              className="w-full border hairline px-3 py-2.5"
              placeholder="admin@example.com"
            />
          </label>

          <label className="block text-sm">
            <span className="block text-[12px] text-[#A9A49A] mb-1">Password</span>
            <input
              required
              type="password"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-[#C6A15B] text-[#0D0D0D] py-3 text-sm tracking-wide hover:bg-[#D8B978] disabled:opacity-60"
          >
            {submitting ? "Signing in…" : "Sign In"}
          </button>
        </form>

        <button onClick={() => go("home")} className="w-full mt-4 text-sm underline text-[#A9A49A]">
          Back to store
        </button>
      </div>
    </div>
...
function AdminPage({
  ...
  const watches = products.filter((product) => product.type === "watch");
  const bracelets = products.filter((product) => product.type === "bracelet");
  ...
  const tabs = [
    ...
    { key: "bracelets", label: `Bracelets (${bracelets.length})` },
  ...
  return (
    <div className="max-w-7xl mx-auto px-5 md:px-8 py-10">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
        <div>
          <p className="text-[13px] text-[#C6A15B] mb-1">Store Administration</p>
          <h1 className="font-display text-3xl md:text-4xl">Dashboard</h1>
        </div>
        <div className="flex gap-3">
          <button onClick={() => go("home")} className="border hairline px-4 py-2 text-sm">
            View Store
          </button>
          <button onClick={adminLogout} className="border border-red-400/40 text-red-300 px-4 py-2 text-sm">
            Log Out
          </button>
        </div>
      </div>

      <div className="flex gap-2 overflow-x-auto border-b hairline mb-8 pb-px">
        {tabs.map((item) => (
          <button
            key={item.key}
            onClick={() => setTab(item.key)}
            className={`whitespace-nowrap px-3 py-2 text-sm border-b-2 ${
              tab === item.key ? "border-[#C6A15B] text-[#C6A15B]" : "border-transparent text-[#A9A49A]"
            }`}
          >
            {item.label}
          </button>
        ...
        <div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {[
              ...
              { label: "Revenue", value: money(revenue, settings) },
            ].map((stat) => (
              <div key={stat.label} className="border hairline p-5">
                <p className="text-sm text-[#A9A49A]">{stat.label}</p>
                <p className="font-display text-2xl mt-2">{stat.value}</p>
              </div>
            ))}
          </div>
          <div className="border hairline p-5">
            <h2 className="font-display text-xl mb-2">Quick start</h2>
            <p className="text-sm text-[#A9A49A]">
              Manage products, update order statuses, review customers, or change the store settings from the tabs above.
            </p>
          </div>
        </div>
      )}
...
function OrdersAdminTable({ orders, setOrders, settings }) {
  ...
  const updateStatus = async (id, status) => {
    ...
    const { error } = await supabase.from(ORDER_TABLE).update({ status }).eq("order_id", id);
